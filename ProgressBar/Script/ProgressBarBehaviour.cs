...
//		private float maxValue, curValue = 0;
		...
		/// Значение value - это текущее значение прогресса ввиде процентов. 
		...
		public void SetMaxValue(float crValue, float mxValue)
		{
			string temp = crValue + " / " + mxValue;
			m_AttachedText.text = temp;
		}
